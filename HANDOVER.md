...
# 4) E2E 32건 — playwright.config.js 가 API·dev 서버를 자동 기동한다
npx playwright test
...
**합격 기준**: lint 0 error · unit 123/123 · server 97/97 · 빌드 성공 · **E2E 32/32(skip 0)**.
...
| 실사 §5.4-12 인스펙터 패널 (= P3-5) | ⬜ | 다음 UX 사이클 후보 |
| 실사 §5.4-13 키보드 편집 + 명령 팔레트 | ⬜ | 접근성 §5.3 "키보드로 일정 변경 불가"와 같은 뿌리 |
